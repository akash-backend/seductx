...
<div class="forms">
	...
	<div class="row">		
		<div class="form-three widget-shadow">
			<form class="form-horizontal" method="post" action="<?php if(!empty($subscription_plan)){ echo site_url('admin/editSubscriptionPlan');}else{
        	echo  base_url('admin/addUserSubscriptionPlan');
