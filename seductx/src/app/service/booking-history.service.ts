...
export class BookingHistoryService {
    ...
    getRequests(requestsPerPage: number, currentPage: number, userId: string) {
      ...
      requestSendData.append('user_id', userId);
    ...
    deleteBooking(bookingId: string) {
      const requestData = new FormData();
      requestData.append('booking_id', bookingId);
      requestData.append('user_booking_status', '2');

      return this.http.post(
        API_URL + '/updateBooking/', requestData
      );
    }
