...
@Component({
  selector: 'app-escort-signup',
  templateUrl: './escort-signup.component.html',
  styleUrls: ['./escort-signup.component.css']
})
export class EscortSignupComponent implements OnInit , OnDestroy {
