...
@Component({
  selector: 'app-create-escort',
  templateUrl: './create-escort.component.html',
  styleUrls: ['./create-escort.component.css']
})
export class CreateEscortComponent implements OnInit , OnDestroy {
  ...
  constructor(
    ...
    public authAgentService: AuthAgentService,
  ...
  ngOnInit() {
    ...
    this.agentId = this.authAgentService.getAgentId();
